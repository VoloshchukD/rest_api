...
public final class ConstantQuery {
    ...
    public static final String FIND_CERTIFICATE_BY_TAG_NAME_QUERY = "SELECT * FROM gift_certificates " +
    ...
    public static final String FIND_CERTIFICATES_BY_PART_OF_NAME_AND_DESCRIPTION_QUERY = "SELECT * " +
    ...
    public static final String FIND_SORTED_CERTIFICATES_QUERY = "WITH constants (sortParam) " +
            "AS (values (?))\n" +
